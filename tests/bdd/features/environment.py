...
def before_all(context):
    ...
    context.default_browser = os.environ.get('KAIZEN_BROWSER', '')
    context.base_url = get_base_url(os.environ['KAIZEN_URL'])
    context.vars = {}
    context.vars["username"] = os.environ.get('KAIZEN_USER')
    context.vars["password"] = os.environ.get('KAIZEN_PASS')
...
def after_scenario(context, scenario):
    if scenario.status == 'failed':
        ...
        You can debug the step with ipdb by setting a trace:
