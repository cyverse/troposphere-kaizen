                    ...
                    <div className="row" style={{ margin: 0, backgroundColor: '#f2f2f2', height: '100%' }}>
                        ...
                        <div className="col" style={{ backgroundColor: 'white' }}>
                            <AdvancedNavigation
                                ...
                                helpText={'Deployment scripts will be executed when a user has launched their instance. They will also be executed each time an instance is "Started", "Resumed", or "Restarted". As such, these scripts should be able to handle being run multiple times without adverse effects.'}
                            />
                        </div>
                        <div className="col-8">
                            <div className="row">
